...
namespace control
{
  Autopilot::Autopilot():  nh_(ros::NodeHandle()), nh_p("~")
  {
    ...
    commands_sub = nh_.subscribe("fw_position_cmd", 1, &Autopilot::commandsCallback, this);
