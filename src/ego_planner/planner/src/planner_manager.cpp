...
namespace ego_planner
{
  ...
  void EGOPlannerManager::initPlanModules(ros::NodeHandle &nh)
  {
    ...
    nh.param("ego_planner_manager/max_jerk", pp_.max_jerk_, -1.0);
    nh.param("ego_planner_manager/feasibility_tolerance", pp_.feasibility_tolerance_, 0.0);
    nh.param("ego_planner_manager/control_points_distance", pp_.ctrl_pt_dist, -1.0);
    nh.param("ego_planner_manager/planning_horizon", pp_.planning_horizen_, 5.0);
